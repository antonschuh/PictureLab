...
public class Picture extends SimplePicture 
{
 ...
 ////////////////////// methods ///////////////////////////////////////
	...
	public void fixUnderwater()
	{
		...
		// higher tolerance means more pixels will be identified as "fish"
	...
	public void copy2(Picture fromPic, int startRow, int endRow, int startCol, int endCol)
	{
				...
				fromRow++, toRow++)
		{
					...
					fromCol++, toCol++)
			{
				...
				//Debug statements.
				System.out.println(	"Fromrow " + fromRow + " toRow " + 
									toRow + " fromCol" + fromCol + 
									" toCol " + toCol);
	...
	public void edgeDetection2(int edgeDist)
	{
		...
		Pixel[][] pixels = this.getPixels2D();
		double[][] edgeAngle = 	new double[Math.round(pixels.length / 
								testHeight)][Math.round(pixels[0].length / testWidth)];
		...
		for (int row = 0; row < pixels.length - testHeight; row += testHeight)
		{
			for (int col = 0; col < pixels[0].length - testWidth; col += testWidth)
			{
				...
				// not actually the greatest value, but corresponding to greatest distance
				// may need to determin which of the two partial clusters is darker, for filling in purposes
